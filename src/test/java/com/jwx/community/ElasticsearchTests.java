...
import com.jwx.community.dao.elasticsearch.DiscussPostRepository;
...
//        discussRepository.deleteById(231);
    ...
    public void testSearchByRepository()
    {
        ...
        //底层调了这个方法查询数据 底层也获取到了高亮显示的值 但是没把高亮内容合到原结果中

        Page<DiscussPost> page = discussRepository.search(searchQuery);
        System.out.println(page.getTotalElements());//一共111条数据
        System.out.println(page.getTotalPages());//12页
        System.out.println(page.getNumber());//当前第0页
        System.out.println(page.getSize());//一页10个
